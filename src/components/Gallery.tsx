...
const Gallery = () => {
  ...
  return <section id="gallery" className="section-padding bg-slate-50">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {galleryItems.map(item => <div key={item.id} className="gallery-item cursor-pointer" onClick={() => handleOpenDialog(item)}>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogContent className="max-w-4xl">
            {selectedItem && <div className="p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <img src={selectedItem.before} alt={`${selectedItem.title} Before`} className="w-full h-auto rounded-md" />
                  </div>
                  <div className="space-y-2">
                    <div className="bg-cyan-500 text-white text-sm py-1 px-3 inline-block">After</div>
                    <img src={selectedItem.after} alt={`${selectedItem.title} After`} className="w-full h-auto rounded-md" />
                  </div>
                </div>
              </div>}
          </DialogContent>
